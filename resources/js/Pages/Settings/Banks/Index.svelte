                            ...
                            <tr onclick={() => openEdit(item)}>
                                ...
                                <td>
                                    <div class="d-flex gap-1 justify-content-end">
                                        ...
                                        <button class="btn btn-sm btn-light border taguara-icon-button-sm" type="button" aria-label="Editar banco" onclick={(e) => { e.stopPropagation(); openEdit(item); }}><Pencil size={15} /></button>
                                    </div>
                                </td>
                            </tr>
                        {:else}
